...
+---------------------------------------------------------+--------------------------------------------------------------------------------------------------------------------------------------+
| Native DBMS support                                     | In FSC: data processing always loads all fields of a tt_content row, no matter if they are needed by the CType or not                |
| (performance, query/order single field with index)      | (but can be configured, but you have to know the fields to exclude or include, what is with 3rd party extensions)                    |
+---------------------------------------------------------+--------------------------------------------------------------------------------------------------------------------------------------+
...
|                               Pros                              |                                 Cons                                |
+=================================================================+=====================================================================+
| Field identifiers need to be unique only within                 | Currently no validation schema for the editing interface definition |
| a content block definition avoiding conflicts on database level |                                                                     |
+-----------------------------------------------------------------+---------------------------------------------------------------------+
...
*  `https://designpatternsphp.readthedocs.io/de/latest/More/EAV/README.html <https://designpatternsphp.readthedocs.io/de/latest/More/EAV/README.html>`__
...
|                                            Pros                                           |                                       Cons                                      |
+===========================================================================================+=================================================================================+
| Field identifiers need to be unique only within a content block definition                | Currently no support by doctrine/dbal                                           |
| avoiding conflicts on database level                                                      |                                                                                 |
+-------------------------------------------------------------------------------------------+---------------------------------------------------------------------------------+
| Size of tt_content isn’t widely extended                                                  | CType switching required mapping of content blocks                              |
+-------------------------------------------------------------------------------------------+---------------------------------------------------------------------------------+
| All of the relevant database management systems have support for XML storage and handling | ExtractValue only returns values.                                               |
|                                                                                           | Thus the whole FlexForm XML would have to be retrieved and extracted in PHP -   |
|                                                                                           | using a DOM parser without DTD/XSD -                                            |
|                                                                                           | see `reference <https://dev.mysql.com/doc/refman/5.6/en/xml-functions.html>`__. |
+-------------------------------------------------------------------------------------------+---------------------------------------------------------------------------------+
| Works als with older databases                                                            | Currently no validation of editing interface definition (schema definition)     |
+-------------------------------------------------------------------------------------------+---------------------------------------------------------------------------------+
| Reduces complexity for content dimensions                                                 | Blob handled as one unit limits to make use of content dimensions (see pros)    |
| (workspaces, language) → also is a con                                                    |                                                                                 |
+-------------------------------------------------------------------------------------------+---------------------------------------------------------------------------------+
| Allows limiting editor permissions for a certain field (appears as an exclude-field)      | Performance: full table scan required to retrieve data                          |
+-------------------------------------------------------------------------------------------+---------------------------------------------------------------------------------+
...
|                                                 Pros                                                 |                                                                        Cons                                                                       |
+======================================================================================================+===================================================================================================================================================+
| Field identifiers need to be unique only within                                                      | Currently no support by doctrine/dbal                                                                                                             |
| a content block definition avoiding conflicts on database level                                      |                                                                                                                                                   |
+------------------------------------------------------------------------------------------------------+---------------------------------------------------------------------------------------------------------------------------------------------------+
| Size of tt_content isn’t widely extended                                                             | CType switching requires mapping of content blocks                                                                                                |
+------------------------------------------------------------------------------------------------------+---------------------------------------------------------------------------------------------------------------------------------------------------+
|                                                                                                      | Requires a modern database, e.g.                                                                                                                  |
|                                                                                                      | `MySQL >= v5.7 <https://dev.mysql.com/doc/refman/5.7/en/json-search-functions.html>`__,                                                           |
| Most/all of the relevant database management systems have support for JSON storage and handling      | `PostgreSQL >=v9.3 <https://www.postgresql.org/docs/9.3/functions-json.html>`__,                                                                  |
|                                                                                                      | `SQLite >= v3.9.0 via json1 extension <https://www.sqlite.org/json1.html>`__,                                                                     |
|                                                                                                      | `SQL Server >= v13.x (SQL Server 2016) <https://docs.microsoft.com/en-us/sql/t-sql/functions/json-functions-transact-sql?view=sql-server-2016>`__ |
+------------------------------------------------------------------------------------------------------+---------------------------------------------------------------------------------------------------------------------------------------------------+
| JSON_EXTRACT returns all relevant indices                                                            | Performance: full table scan required to retrieve data                                                                                            |
+------------------------------------------------------------------------------------------------------+---------------------------------------------------------------------------------------------------------------------------------------------------+
| JSON data type has more functions for manipulating or merging results in a database query than XML-  | Limiting editor permissions for a certain field required extra logic.                                                                             |
| see `reference <https://dev.mysql.com/doc/refman/5.7/en/json.html>`__.                               |                                                                                                                                                   |
+------------------------------------------------------------------------------------------------------+---------------------------------------------------------------------------------------------------------------------------------------------------+
| JSON information can easily be handed over to a client consumer (e.g. “some JavaScript” )            |                                                                                                                                                   |
| → very interesting for headless approach                                                             |                                                                                                                                                   |
+------------------------------------------------------------------------------------------------------+---------------------------------------------------------------------------------------------------------------------------------------------------+
