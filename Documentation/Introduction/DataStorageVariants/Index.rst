...
|                                                                                                                 | Thus the whole FlexForm XML would have to be retrieved and extracted in PHP - using a DOM parser without DTD/XSD - see `reference <https://dev.mysql.com/doc/refman/5.6/en/xml-functions.html>`__. |
+-----------------------------------------------------------------------------------------------------------------+---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
...
|                                                                                                                                                                            | - `PostgreSQL >=v9.3 <https://www.postgresql.org/docs/9.3/functions-json.html>`__                                                                   |
